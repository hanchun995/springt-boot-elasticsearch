...
import com.fsyk.es.dao.ArticleDao;
import com.fsyk.es.entity.Article;
...
public class ArticleSearchRepositoryTest {
    ...
    @Autowired
    private ArticleDao articleSearchRepository;
    @Autowired
...
//        articleSearchRepository.save(article4);
        ...
        //bulk index 批量方式插入
        List<Article> sampleEntities = new ArrayList<Article>();
        sampleEntities.add(article10);
        sampleEntities.add(article9);
        
        sampleEntities.add(article8);
